...
// Reads — gallery has no published/unpublished concept, RLS allows
// everyone to read every row, so the public anon client is enough here
// (used both by the public site and by the admin gallery page).
...
// Mutations — service role after requireAdmin(), including Storage writes.
